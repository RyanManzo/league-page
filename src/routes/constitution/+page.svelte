...
<div class="constitution">
    <h1 class="noUnderscore">Logan's Year Collective Bargaining Agreement</h1>
    ...
    <p class="underscore">Startering Lineup</p>
    <ul>
        <li>QB</li>
        <li>RB</li>
        <li>RB</li>
    ...
    <p>2 Taxi Spots (Dedicated to Rookies)<p>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $500 dollars plus their remaining balance from the previous season. $0 bids are allowed.</p>

    <p>FAAB budgets will be updated before NFL Draft.</p>
    ...
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 6 teams in the league based on record will be granted a playoff birth. The top 2 teams will receive first round byes. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>No team may intentionally leave starting roster spots empty. All players in starting lineup must have a projection greater than 1.00 point(s). Failure to follow the rule will result in a $50 dollar FAAB fine.</p>

    <h2 class="sectionHeading" bind:this={seven}>Section 6 League Finances</h2>
    
    <h3 bind:this={sixOne}>6.1 League Dues</h3>
    <p>League dues are set at {dues}$. Dues will be collected via Venmo to Commisssioner on or before the draft. In the event that a manager fails to pay before the deadline, they will incur a 50$ FAAB fine for every day they are late.</p>
