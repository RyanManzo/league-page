/*   STEP 1   */
export const leagueID = "1180575746661257216"; // your league ID
export const leagueName = "Logan's Year"; // your league name
...
export const homepageText = `
 ...
 <p>As we approach the midway point of the offseason, the main event is finally here: the NFL Draft. Mocks are flying, Adam and Ian are ready to spoil your favorite teams picks, trade talks are nothing but smokescreens, and the inevitable Raiders overdraft is on the horizon.</p>
 <p></p>
 <p></p>
`;
